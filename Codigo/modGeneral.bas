...
'*************************************************
    ...
    If MaxGrhs < 1 Then MaxGrhs = 35000
...
On Error Resume Next
    ...
    'Lorwik> Arrancamos en 200x200

            XMaxMapSize = 200
            YMaxMapSize = 200
    
    If Not Engine_Init Then ' 30/05/2006
        MsgBox "�No se ha logrado iniciar el engine gr�fico! Reinstale los �ltimos controladores de DirectX y actualize sus controladores de video.", vbCritical, "Saliendo"
        End
    End If
    DoEvents
