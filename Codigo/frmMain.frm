...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":6B2E4
         Left            =   1080
         List            =   "frmMain.frx":6B2F4
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":6B304
         Left            =   120
         List            =   "frmMain.frx":6B306
         Sorted          =   -1  'True
         TabIndex        =   61
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":6B308
         Left            =   3360
         List            =   "frmMain.frx":6B30A
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":6B30C
         Left            =   840
         List            =   "frmMain.frx":6B30E
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":6B310
         Left            =   120
         List            =   "frmMain.frx":6B312
         TabIndex        =   56
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":6B314
         Left            =   840
         List            =   "frmMain.frx":6B316
         TabIndex        =   48
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":6B318
         Left            =   3360
         List            =   "frmMain.frx":6B31A
         TabIndex        =   47
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":6B31C
         Left            =   120
         List            =   "frmMain.frx":6B31E
         TabIndex        =   45
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":6B320
         Left            =   120
         List            =   "frmMain.frx":6B322
         TabIndex        =   44
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6B324
         Left            =   840
         List            =   "frmMain.frx":6B326
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":6B328
         Left            =   120
         List            =   "frmMain.frx":6B32A
         TabIndex        =   69
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6B32C
         Left            =   3360
         List            =   "frmMain.frx":6B32E
         TabIndex        =   70
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
