...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":6AE2E
         Left            =   1080
         List            =   "frmMain.frx":6AE3E
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":6AE4E
         Left            =   120
         List            =   "frmMain.frx":6AE50
         Sorted          =   -1  'True
         TabIndex        =   61
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":6AE52
         Left            =   3360
         List            =   "frmMain.frx":6AE54
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":6AE56
         Left            =   840
         List            =   "frmMain.frx":6AE58
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":6AE5A
         Left            =   120
         List            =   "frmMain.frx":6AE5C
         TabIndex        =   56
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":6AE5E
         Left            =   840
         List            =   "frmMain.frx":6AE60
         TabIndex        =   48
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":6AE62
         Left            =   3360
         List            =   "frmMain.frx":6AE64
         TabIndex        =   47
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":6AE66
         Left            =   120
         List            =   "frmMain.frx":6AE68
         TabIndex        =   45
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":6AE6A
         Left            =   120
         List            =   "frmMain.frx":6AE6C
         TabIndex        =   44
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6AE6E
         Left            =   840
         List            =   "frmMain.frx":6AE70
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":6AE72
         Left            =   120
         List            =   "frmMain.frx":6AE74
         TabIndex        =   69
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6AE76
         Left            =   3360
         List            =   "frmMain.frx":6AE78
         TabIndex        =   70
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
...
Dim X As Integer
    ...
    Select Case index
        Case 0 'Arriba
            For Y = 1 To 11
                For X = 1 To 200
                    MapData(X, Y).Graphic(1) = MapData_Adyacente(X, Y + 177).Graphic(1)
                    MapData(X, Y).Graphic(2) = MapData_Adyacente(X, Y + 177).Graphic(2)
                    MapData(X, Y).Graphic(3) = MapData_Adyacente(X, Y + 177).Graphic(3)
                    MapData(X, Y).Graphic(4) = MapData_Adyacente(X, Y + 177).Graphic(4)
                Next
            Next
            MapInfo.Changed = 1
        ...
        Case 1 'Derecha
            For Y = 1 To 200
                For X = 189 To 200
                    MapData(X, Y).Graphic(1) = MapData_Adyacente(X - 177, Y).Graphic(1)
                    MapData(X, Y).Graphic(2) = MapData_Adyacente(X - 177, Y).Graphic(2)
                    MapData(X, Y).Graphic(3) = MapData_Adyacente(X - 177, Y).Graphic(3)
                    MapData(X, Y).Graphic(4) = MapData_Adyacente(X - 177, Y).Graphic(4)
                Next
            Next
            MapInfo.Changed = 1
...
On Error Resume Next
With Dialog
    .Filter = "Mapas de AODrag (*.csm)|*.csm|Mapas de Argentum Online (*.map)|*.map"
    If Guardar Then
            .DialogTitle = "Guardar"
            .DefaultExt = ".txt"
