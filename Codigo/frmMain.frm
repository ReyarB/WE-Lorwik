...
Begin VB.Form frmMain 
   ...
   Caption         =   "WorldEditor Versi�n 2.0.56  ReyarB"
   ClientHeight    =   14415
   ClientLeft      =   3270
   ClientTop       =   690
   ClientWidth     =   22290
   ...
   Begin WorldEditor.lvButtons_H LvBGuardarMinimapa 
      ...
      cBack           =   -2147483633
   End
   Begin WorldEditor.lvButtons_H SelectPaneleExtra 
      Height          =   1275
      Index           =   0
      Left            =   22440
      TabIndex        =   208
...
Private Sub SelectPaneleExtra_Click(index As Integer)
Call Resolucion
Call modEdicion.Bloquear_Bordes(1)
End Sub
