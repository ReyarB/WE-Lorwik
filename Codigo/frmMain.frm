...
If Len(Dialog.FileName) < 3 Then Exit Sub
    ...
    'Tambien podrÃ¯Â¿Â½ elegir CSM, pero no habra diferencia
...
'Last modified: 25/04/2020
'*************************************************
'Nota: Hay que cambiar muchas cosas, el engine cuando inicia hace calculos con el tamaÃ¯Â¿Â½o de los mapas
